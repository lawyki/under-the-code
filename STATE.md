...
ratified book-wide and recorded in `UNDER.md` §5), ran the closing audits
clean (cross-part consistency read — four fact-class cross-reference breaks
found and fixed; 462 hrefs + 519 glossary refs, 0 broken; figure sweeps
0 new findings against a HEAD-identical baseline; full §7 harness 100/100;
docs registries realigned), and confirmed live parity after push. Anchor-id
sets byte-identical in all five parts (354/346/380/228/189).
